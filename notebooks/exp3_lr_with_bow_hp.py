...
df['sentiment'] = df['sentiment'].replace({'sadness':0, 'happiness':1}).astype('int64')
...
with mlflow.start_run():
    ...
    # Perform grid search
    grid_search = GridSearchCV(estimator=LogisticRegression(), param_grid=param_grid, cv=5, scoring='f1', n_jobs=-1)
